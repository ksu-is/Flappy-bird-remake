...
#Map will appear more zoomed in than base code to give it more similarity to the orginial 2013 game.
#creating main menu
...
# Game images above are different from orginal source
